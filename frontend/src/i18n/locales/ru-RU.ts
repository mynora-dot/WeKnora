export default {
  ...
  platform: {
    subtitle: 'Персональный ИИ-помощник для знаний',
    description: 'Организуйте личные документы, быстро находите нужное и задавайте вопросы',
    ...
    independentTenant: 'Личное пространство',
    fullApiAccess: 'Самостоятельная организация материалов',
    knowledgeBaseManagement: 'Поиск и просмотр в любое время',
    carousel: {
  ...
  auth: {
    ...
    registerFailed: 'Ошибка регистрации',
    subtitle: 'Организуйте личные материалы, ищите, спрашивайте и возвращайтесь к ним в любое время',
    registerSubtitle: 'Создайте личный аккаунт и начните упорядочивать свои знания',
