export default {
  ...
  auth: {
    ...
    subtitle: '個人の資料を整理し、いつでも検索・質問・振り返り',
    registerSubtitle: '個人アカウントを作成して、知識の整理を始めましょう',
  ...
  platform: {
    subtitle: '個人向けAIナレッジアシスタント',
    description: '個人の資料を整理し、必要なときにすばやく検索・質問できます',
    rag: 'RAG拡張生成',
    agent: 'ReActエージェント',
    wiki: 'Wikiナレッジベース',
    ...
    independentTenant: '個人専用スペース',
    fullApiAccess: '自分の資料を自由に整理',
    knowledgeBaseManagement: 'いつでも検索・振り返り',
    carousel: {
