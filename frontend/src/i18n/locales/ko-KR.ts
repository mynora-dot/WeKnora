export default {
  ...
  platform: {
    subtitle: '개인을 위한 AI 지식 도우미',
    description: '개인 문서를 정리하고 필요할 때 빠르게 검색하고 질문하세요',
    rag: 'RAG 강화 생성',
    agent: 'ReAct 에이전트',
    wiki: 'Wiki 지식베이스',
    ...
    independentTenant: '개인 전용 공간',
    fullApiAccess: '내 자료를 자유롭게 정리',
    knowledgeBaseManagement: '언제든 검색하고 돌아보기',
    carousel: {
  ...
  auth: {
    ...
    subtitle: '개인 자료를 정리하고 언제든 검색하고 질문하고 돌아보세요',
    registerSubtitle: '개인 계정을 만들고 지식 정리를 시작하세요',
