export default {
  ...
  auth: {
    ...
    subtitle: 'Organize your personal material, then search, ask, and review anytime',
    registerSubtitle: 'Create a personal account and start organizing your knowledge',
  ...
  platform: {
    subtitle: 'A Personal AI Knowledge Assistant',
    description: 'Organize personal documents, search quickly, and ask questions whenever you need them',
    ...
    independentTenant: 'Private Personal Space',
    fullApiAccess: 'Organize Your Own Material',
    knowledgeBaseManagement: 'Search and Review Anytime',
    carousel: {
