export default {
  ...
  platform: {
    subtitle: '面向个人的智能知识助手',
    description: '整理个人文档、快速检索与问答，让日常资料更容易查找和使用',
    rag: 'RAG 增强生成',
    agent: 'ReAct 智能体',
    wiki: 'Wiki 知识库',
    hybridSearch: '混合检索',
    ...
    independentTenant: '个人专属空间',
    fullApiAccess: '个人资料自主整理',
    knowledgeBaseManagement: '随时检索与回顾',
    carousel: {
  ...
  auth: {
    ...
    registerFailed: '注册失败',
    subtitle: '整理个人资料，随时检索、问答与回顾',
    registerSubtitle: '创建个人账户，开始整理你的知识',
